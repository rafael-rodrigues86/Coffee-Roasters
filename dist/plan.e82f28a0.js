...
class HandleCard {
    constructor(){
        ...
        this.arrayPrices = [];
        this.stateManager;
        this.grindEl = document.querySelector("div.questions__cards[data-order='3']");
        this.asideItem = document.querySelectorAll(".aside__item");
        this.asideGrind = document.querySelector("li.aside__item[data-order='3']");
        this.arrowGrind = document.querySelector(".questions__item[data-order='3'] img");
        this.orderSummarySpans = Array.from(document.querySelectorAll(".questions__summary p span"));
    ...
    arrowUp(element) {
        element.src = require("ffbb45d79f4feb60");
    }
    arowDown(element) {
        element.src = require("9bd1228c3852d5a4");
    }
    ...
    handleShipment(items) {
        ...
        switch(this.coffeeWeight){
            case "250g":
                ...
                this.updateDeliveryPrices(this.shipmentPriceWeek, this.shipmentPrice2Weeks, this.shipmentPriceMonth);
                break;
            case "500g":
    ...
    handleOrderSummary(items) {
        ...
        this.orderSummaryP.innerHTML = `I drink my coffee ${this.arrayItem0 === "Capsule" ? "as <span>Capsule</span>" : "using <span>" + this.arrayItem0 + "</span>"}, with a <span>${this.arrItens[1] ?? "____"}</span> type of bean. <span>${this.arrItens[2] ?? "____"}</span> ${this.arrItens[0] === "Capsule" ? "" : "ground ala <span>" + this.arrayItem3 + "</span>"}, sent to me <span>${this.arrItens[4] ?? "____"}<span/>`;
    }
    handleArrowClick(e) {
        ...
        if (!this.cards.classList.contains("questions__cards--inativo")) this.cards.classList.toggle("questions__cards--ativo");
        console.log(this.cards);
        console.log(this.isClickOnArrow);
        if (this.cards.classList.contains("questions__cards--ativo") && !this.cards.classList.contains("questions__cards--inativo")) {
            ...
            this.cardsChildren.forEach((cardChild)=>cardChild.classList.remove("questions__card--selected"));
    ...
    handleCardClick(e) {
        ...
        this.allThreeCards.forEach((card)=>card.classList.remove("questions__card--selected")); // Remove a classe de todos os 3 cards para não ficar mais de um elemento selecionado
...
},{"d184fa7280d19eb":"lgJ39"}],"lgJ39":[function(require,module,exports) {
"use strict";
var bundleURL = {};
...
},{}],"dATqc":[function(require,module,exports) {
module.exports = require("4f3ec4860047fa7a").getBundleURL("2MSMO") + "icon-arrow-down.fd8d8f00.svg" + "?" + Date.now();

},{"4f3ec4860047fa7a":"lgJ39"}]},["4tgfT","dV6cC"], "dV6cC", "parcelRequiref90e")

//# sourceMappingURL=plan.e82f28a0.js.map
